...
var determinePattern = function(dataPoints, getDatumOfInterest, attributeName){
	...
	var elementId = dataPoints[0]["elementId"];
	...
	if(dataPoints.length > 4 && chunkStartIndices.length == (dataPoints.length - 1)){
		...
		for(var i = 0; i < chunkStartIndices.length; i++){
			...
			chunkLineFitData.push( { "m": m, "c": c, "start": chunkStart, "end": chunkEnd, "elementId": elementId } );
		}
		//console.log(chunkLineFitData);
...
var examplePoints = [
{"pageWidth": 1000, "left": 50, "right": 850, "elementWidth": 100, "elementId": "myBox"},
{"pageWidth": 1500, "left": 75, "right": 1375, "elementWidth": 100, "elementId": "myBox"},
{"pageWidth": 500, "left": 25, "right": 375, "elementWidth": 100, "elementId": "myBox"},
{"pageWidth": 250, "left": 25, "right": 375, "elementWidth": 100, "elementId": "myBox"},
{"pageWidth": 0, "left": 25, "right": 375, "elementWidth": 100, "elementId": "myBox"},
{"pageWidth": 1750, "left": 75, "right": 1375, "elementWidth": 100, "elementId": "myBox"},
{"pageWidth": 2000, "left": 75, "right": 1375, "elementWidth": 100, "elementId": "myBox"},
{"pageWidth": 2001, "left": 75, "right": 1375, "elementWidth": 100, "elementId": "myBox"}
];
...
generateCSSFromExamples(dataPoints);